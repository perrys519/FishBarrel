...
var FishBarrelAI = (function () {
    var DEFAULT_PROMPT_TEMPLATE = [
        ...
        '',
        '3. ARTICLE / EXPLANATORY EFFICACY CLAIMS — when blog posts, FAQs, or "How it works" sections describe the treatment as effective for named conditions. These are violations even when phrased as background information. Examples:',
        '   • "Research/studies report [Treatment] helps with [conditions]" — naming research as backing is still a claim of efficacy',
        '   • "[Treatment] is a technique for stress reduction and relaxation that also promotes healing"',
        '   • "[Treatment] energy works in harmony with all other forms of healing... and will improve the results"',
        '   • "Reiki energy flows into the energy centres and into muscles and cells"',
        '   • "Life force nourishes the organs and cells of the body, supporting them in their vital functions"',
        '   • Any sentence asserting a named condition (anxiety, insomnia, fibromyalgia, cancer, pain, depression, etc.) is helped, treated, eased, relieved, addressed or improved by the treatment.',
        '',
        ...
        '',
        'IMPORTANT: claims attributed to research, studies, or academic articles are STILL claims under {REGULATOR}. The site is responsible for the claims it publishes regardless of who it says is making them.',
        '',
